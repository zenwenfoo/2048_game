        ...
        for(let i = 0; i < size; i++)
        {
            for(let j = 0; j < size; j++)
            {
                ...
                if(currentValue !== 0)
                {
                    ...
                    // Animation handling
                    if(currentValue !== parseInt
                    (prevValue) && !cell.classList.contains('new-tile'))
                    {
    ...
    function checkGameOver()
    {
        for(let i = 0; i < size; i++)
        {
            for(let j = 0; j < size; j++)
            {
                ...
                {
                    return; // There are horizontally adjacent equal cells, so a move is 
                            // possible
                }
                if (i < size - 1 && board[i][j] === board[i + 1][j])
                {
                    return; // There are vertically adjacent equal cells, so a move is 
                            // possible
                }
            }
        }
